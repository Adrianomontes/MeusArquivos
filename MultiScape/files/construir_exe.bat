...
echo.
echo  ╔══════════════════════════════════════════════════════════════╗
echo  ║     MULTI ESCAPE ERP — Gerador de Executável (.exe)         ║
...
IF EXIST "dist\MultiEscape_ERP.exe" (
    echo  [INFO] Removendo versao anterior...
    del /q "dist\MultiEscape_ERP.exe" >nul 2>&1
)
IF EXIST "build" (
...
pyinstaller MultiEscape.spec --noconfirm --clean
...
IF NOT EXIST "dist\MultiEscape_ERP.exe" (
    echo.
    echo  [ERRO] Executavel nao encontrado em dist\MultiEscape_ERP.exe
...
FOR %%F IN ("dist\MultiEscape_ERP.exe") DO SET EXE_SIZE=%%~zF
...
echo  ║                                                              ║
echo  ║  Arquivo: dist\MultiEscape_ERP.exe                          ║
echo  ║  Tamanho: ~%EXE_MB% MB                                          ║
echo  ║                                                              ║
echo  ║  Para distribuir:                                            ║
echo  ║  1. Copie a pasta  dist\  para um pendrive ou envie         ║
echo  ║  2. O destinatario clica duas vezes em MultiEscape_ERP.exe  ║
